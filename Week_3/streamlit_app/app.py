...
MODEL_PATH  = os.path.join(BASE_DIR, "artifacts", "model_xgb_smote.pkl")        # sadece model
SCHEMA_PATH = os.path.join(BASE_DIR, "artifacts", "feature_schema_smote.json")  # SMOTE şeması
PRE_PATH    = os.path.join(BASE_DIR, "artifacts", "preprocessor_smote.pkl")     # ön-işlemci
