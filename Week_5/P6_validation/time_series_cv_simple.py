...
def load_data():
    ...
    # Platform-bağımsız path oluşturma
    current_dir = os.path.dirname(os.path.abspath(__file__))
    artifacts_path = os.path.join(os.path.dirname(current_dir), 'P2_feature_engineering', 'artifacts', 'datasets')
    
    train_path = os.path.join(artifacts_path, 'fe_train.parquet')
    valid_path = os.path.join(artifacts_path, 'fe_valid.parquet')
    
    print(f"   📍 Path kontrol: {train_path}")
