...
def clean_titanic_data(input_path='data/raw/titanic.csv', output_path='data/processed/titanic_processed.csv'):
    """Titanic datasetini temizle ve özellik mühendisliği yap."""
